...
import nl.pieni.maven.dependency_graph.neo4j.database.impl.DependencyDatabaseImpl;
...
import static nl.pieni.maven.dependency_graph.neo4j.enums.NodeProperties.*;
...
public class DependencyReportMojo extends AbstractDependencyMojo {
    ...
    /**
     * Print Relations to the specified node. Only the relations defined in {@link nl.pieni.maven.dependency_graph.neo4j.enums.DependencyScopeRelations}
     * are processed
     *
